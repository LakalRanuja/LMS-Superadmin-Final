...
import { DollarSign, TrendingUp, User, Check, Star, Flag, Phone, Mail, Calendar } from 'react-feather'
              ...
              <div className='d-flex justify-content-start'>
                ...
                <div className='d-flex flex-column ml-1'>
                  ...
                  <div className='d-flex flex-wrap align-items-center'>
                    <Button.Ripple tag={Link} to={`/apps/school/edit/${selectedUser.id}`} color='primary'>
                      Edit
                    </Button.Ripple>
            ...
            <div className='user-info-wrapper'>
              ...
              <div className='d-flex flex-wrap align-items-center my-50'>
                ...
                <CardText className='text-capitalize mb-0'>
                  {selectedUser !== null ? selectedUser.PrinName : 'Active'}
                </CardText>
              </div>
              <div className='d-flex flex-wrap align-items-center my-50'>
                <div className='user-info-title'>
              ...
              <div className='d-flex flex-wrap align-items-center my-50'>
                ...
                <CardText className='mb-0'>{selectedUser !== null ? selectedUser.teaCount : 'England'}</CardText>
              </div>
              <div className='d-flex flex-wrap align-items-center'>
                <div className='user-info-title'>
                  <Star className='mr-1' size={14} />
                ...
                <CardText className='mb-0'>{selectedUser !== null ? selectedUser.stuCount : '(123) 456-7890'}</CardText>
              </div>
              <div className='d-flex flex-wrap align-items-center my-50'>
                <div className='user-info-title'>
                  <Star className='mr-1' size={14} />
                ...
                <CardText className='mb-0'>{selectedUser !== null ? selectedUser.hours : 'England'}</CardText>
              </div>
              <div className='d-flex align-items-center'>
                  <Calendar size={14} />
                  <Flatpickr
                    options={{
                      mode: 'range',
                      defaultDate: ['2021-04-01', '2021-04-15']
                    }}
