...
const Tasks = props => {
  ...
  const dataObjArray = [
    {title : "An Apple", description : "Online free AI English to Microsoft, IBM, Naver, Yandex and Baidu.", school:"Ananda College", file : null},
    {title : "The Google", description : "English to Sinhala translator powered by Google, Microsoft, IBM, Naver, Yandex and Baidu.", school:"Royal College", file : null},
    {title : "The Yandex", description : "Online free AI English to Sinhala translator powered by Google, Microsoft, IBM, Naver, Yandex and Baidu.", school:"Mahanama College", file : null},
    {title : "Microsoft", description : "Online free AI English to Sinhala translator powered by Google", school:"Sen.Johns College", file : null},
    {title : "Baidu", description : "English to Sinhala translator powered by Google, Microsoft, IBM, Naver, Yandex and Baidu.", school:"Isipathana College", file : null}
  ]
  const dataObjArray2 = [
    {title : "An Red Apple", description : "Online free AI English to Microsoft, IBM, Naver, Yandex and Baidu.", school:"Ananda College", file : null},
    {title : "The Small Google", description : "English to Sinhala translator powered by Google, Microsoft, IBM, Naver, Yandex and Baidu.", school:"Royal College", file : null},
    {title : "The Large Yandex", description : "Online free AI English to Sinhala translator powered by Google, Microsoft, IBM, Naver, Yandex and Baidu.", school:"Mahanama College", file : null},
    {title : "My Self", description : "Online free AI English to Sinhala translator powered by Google", school:"Sen.Johns College", file : null},
    {title : "Baidu", description : "English to Sinhala translator powered by Google, Microsoft, IBM, Naver, Yandex and Baidu.", school:"Isipathana College", file : null}
  ]
                ...
                {/* [UPDATES] */}
                 {state.toggleNavClasses  ? <div className="col-12">
                    ...
                    <div className="row bg-white rounded mr-1 shadow py-1 myContainer">
                         <div className="col-8 px-2">
                          <FormGroup className="col-12">
                              ...
                              <Input type="text" name="email" id="exampleEmail" size = "sm" placeholder="" className= " border border-primary bg-white" />
                            </FormGroup>

                            <FormGroup className="col-12">
                              <Label for="exampleText">Description</Label>
                              <Input type="textarea" name="text" id="exampleText" size = "sm" placeholder="" className= " border border-primary " />
                            </FormGroup>
                         </div>

                         <div className="col-4  px-1">
                              <Button className="col-12 mb-1 mt-2" size = "sm" color="primary">Send</Button>
                    ...
                    <Table size="sm" hover >
                        ...
                        <tbody >
                        {/* here */}
                         { dataObjArray.map((item) => <RowData title= {item.title} description= {item.description} school= {item.school} />)}
